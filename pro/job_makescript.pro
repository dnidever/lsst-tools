...
;  =dir     The directory to put the job script in.
;  =name    The name to call the job script (without the '.sh' or '.batch' ending).
...
;  =prefix  The prefix to use for the job script name. "pr" by default.
;  /hyperthread  Not on a job server but one with multiple hyperthreaded
;                  processors.
;
; OUTPUTS:
