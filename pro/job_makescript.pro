pro job_makescript,input,dir=dir0,name=name,scriptname=scriptname,$
...
;
; USAGE:
;  IDL>job_makescript,input,dir=dir,name=name,idle=idle,scriptname=scriptname,$
...
if ninput eq 0 then begin
  print,'Syntax - job_makescript,input,dir=dir,name=name,scriptname=scriptname,'
